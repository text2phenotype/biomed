...
from biomed.pdf_embedding.create_pdf_highlight import embed_write_pdf, create_highlights
...
def main(args):
    ...
    for uuid in uuids:
        ...
        res = embed_write_pdf(
            ...
            output_pdf_path=os.path.join(args.pdf_output_dir, f'{uuid}.embedded.pdf'),
